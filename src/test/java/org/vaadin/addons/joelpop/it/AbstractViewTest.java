package org.vaadin.addons.joelpop.it;
...
public abstract class AbstractViewTest extends ParallelTest {
    ...
    protected void assertThemePresentOnElement(
        ...
        Boolean hasStyle = (Boolean) executeScript("""
            var styles = Array.from(arguments[0]._template.content.querySelectorAll('style'))
                .filter(style => style.textContent.indexOf('%s') > -1);
